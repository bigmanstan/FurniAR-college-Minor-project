...
public class ImageMetadata {
    ...
    private final C0371a sketchEntry;
    ...
    ImageMetadata(long j, Session session) {
        ...
        this.nativeHandle = j;
        this.sketchEntry = new C0371a();
    }

    private void getMetdataEntry(int i, C0371a c0371a) {
        c0371a.f20a = nativeGetMetadataEntry(this.session.nativeHandle, this.nativeHandle, i);
        if (c0371a.f20a != 0) {
            c0371a.f21b = nativeGetMetadataEntryValueType(this.session.nativeHandle, c0371a.f20a);
            c0371a.f22c = nativeGetMetadataEntryValueCount(this.session.nativeHandle, c0371a.f20a);
            return;
        }
    ...
    public byte getByte(int i) {
        ...
        if (this.sketchEntry.f21b == 0 && this.sketchEntry.f22c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public byte[] getByteArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 4 && this.sketchEntry.f22c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public double[] getDoubleArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 2 && this.sketchEntry.f22c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public float[] getFloatArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 1 && this.sketchEntry.f22c == 1) {
            i = nativeGetIntFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            return i;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", new Object[]{Integer.valueOf(i)}));
    ...
    public int[] getIntArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 3 && this.sketchEntry.f22c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public long[] getLongArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 5 && this.sketchEntry.f22c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
    ...
    public Rational[] getRationalArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f21b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
            nativeDestroyMetadataEntry(this.session.nativeHandle, this.sketchEntry.f20a);
