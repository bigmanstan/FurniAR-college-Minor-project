...
class SessionCreateJniHelper {
    ...
    @UsedByNative("session_create.cc")
    static boolean checkApkSignature(Context context) throws NameNotFoundException {
        try {
            ...
            for (Signature signature2 : packageInfo.signatures) {
                ...
                String toCharsString = signature.toCharsString();
                String toCharsString2 = signature2.toCharsString();
                StringBuilder stringBuilder = new StringBuilder((String.valueOf(toCharsString).length() + 39) + String.valueOf(toCharsString2).length());
                stringBuilder.append("Signature mismatch.  Expected '");
                stringBuilder.append(toCharsString);
                stringBuilder.append("' got '");
                stringBuilder.append(toCharsString2);
                stringBuilder.append("'");
                Log.w("ARCore-SessionCreateJniHelper", stringBuilder.toString());
            }
