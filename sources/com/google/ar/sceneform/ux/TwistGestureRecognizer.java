...
public class TwistGestureRecognizer extends BaseGestureRecognizer<TwistGesture> {
    ...
    public interface OnGestureStartedListener extends com.google.ar.sceneform.ux.BaseGestureRecognizer.OnGestureStartedListener<TwistGesture> {
    }
                            ...
                            while (i < motionEvent.getPointerCount()) {
                                ...
                                if (pointerId == actionId) {
                                    if (this.gesturePointersUtility.isPointerIdRetained(pointerId)) {
                                        this.gestures.add(new TwistGesture(this.gesturePointersUtility, motionEvent, pointerId));
                                    }
                                }
                                i++;
                            }
