...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C01191();
    private final OnTouchListener mTouchListener = new C01202();
    ...
    class C01202 implements OnTouchListener {
        C01202() {
        }
