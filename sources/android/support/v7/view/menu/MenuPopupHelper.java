...
public class MenuPopupHelper implements MenuHelper {
    ...
    class C02861 implements OnDismissListener {
        C02861() {
        }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu) {
        this(context, menu, null, false, C0015R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView) {
        this(context, menu, anchorView, false, C0015R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView, boolean overflowOnly, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mInternalOnDismissListener = new C02861();
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(displaySize.x, displaySize.y) >= this.mContext.getResources().getDimensionPixelSize(C0015R.dimen.abc_cascading_menus_min_smallest_width)) {
    ...
    private void showPopup(int xOffset, int yOffset, boolean useOffsets, boolean showTitle) {
        ...
        if (useOffsets) {
            ...
            int halfSize = (int) ((48.0f * this.mContext.getResources().getDisplayMetrics().density) / ErrorDialogData.SUPPRESSED);
