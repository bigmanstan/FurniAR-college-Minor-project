...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02882();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02871();
    ...
    class C02871 implements OnGlobalLayoutListener {
        C02871() {
        }
    ...
    class C02882 implements OnAttachStateChangeListener {
        C02882() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0015R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            if (this.mAnchorView != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0015R.layout.abc_popup_menu_header_item_layout, listView, false);
