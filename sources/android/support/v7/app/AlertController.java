...
class AlertController {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (this.mCursor == null) {
                    ...
                    c02671 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    ...
                    BaseAdapter c02682 = new CursorAdapter(this.mContext, this.mCursor, false) {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0015R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0015R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0015R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0015R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0015R.styleable.AlertDialog, C0015R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0015R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0015R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0015R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0015R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0015R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0015R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0015R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0015R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        ...
        int i2;
        ListView listView;
        View parentPanel = this.mWindow.findViewById(C0015R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0015R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0015R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0015R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0015R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0015R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0015R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0015R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0015R.id.textSpacerNoButtons);
            if (spacer != null) {
                ...
                if (hasTopPanel) {
                    ...
                    if (!(r0.mMessage == null && r0.mListView == null)) {
                        parentPanel = topPanel.findViewById(C0015R.id.titleDividerNoCustom);
                    }
                    if (parentPanel != null) {
                        parentPanel.setVisibility(0);
                    }
                } else if (contentPanel != null) {
                    parentPanel = contentPanel.findViewById(C0015R.id.textSpacerNoTitle);
                    if (parentPanel != null) {
                        i = 0;
                        parentPanel.setVisibility(0);
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0015R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0015R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0015R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0015R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if ((TextUtils.isEmpty(this.mTitle) ^ 1) && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0015R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0015R.id.scrollView);
