...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C05771();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C05782();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04863();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C04863 implements ViewPropertyAnimatorUpdateListener {
        C04863() {
        }
    ...
    class C05771 extends ViewPropertyAnimatorListenerAdapter {
        C05771() {
        }
    ...
    class C05782 extends ViewPropertyAnimatorListenerAdapter {
        C05782() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0015R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0015R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0015R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0015R.id.action_bar_container);
        ...
        if (!abp.enableHomeButtonByDefault()) {
            if (!homeAsUp) {
                ...
                a = this.mContext.obtainStyledAttributes(null, C0015R.styleable.ActionBar, C0015R.attr.actionBarStyle, 0);
                if (a.getBoolean(C0015R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                elevation = a.getDimensionPixelSize(C0015R.styleable.ActionBar_elevation, 0);
                if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0015R.attr.actionBarWidgetTheme, outValue, true);
