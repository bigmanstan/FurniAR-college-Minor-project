...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C04892();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C04881();
    ...
    class C04881 implements MainThreadCallback<T> {
        C04881() {
        }
    ...
    class C04892 implements BackgroundCallback<T> {
