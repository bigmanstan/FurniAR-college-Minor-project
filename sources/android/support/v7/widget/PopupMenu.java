...
public class PopupMenu {
    ...
    class C03162 implements android.widget.PopupWindow.OnDismissListener {
        C03162() {
        }
    ...
    class C05041 implements Callback {
        C05041() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0015R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C05041());
        ...
        this.mPopup.setOnDismissListener(new C03162());
    }
