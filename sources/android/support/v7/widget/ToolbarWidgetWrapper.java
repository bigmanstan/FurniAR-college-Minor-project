...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0015R.string.abc_action_bar_up_description, C0015R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, C0015R.styleable.ActionBar, C0015R.attr.actionBarStyle, 0);
        r0.mDefaultNavigationIcon = a.getDrawable(C0015R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
            CharSequence title = a.getText(C0015R.styleable.ActionBar_title);
            if (!TextUtils.isEmpty(title)) {
                setTitle(title);
            }
            CharSequence subtitle = a.getText(C0015R.styleable.ActionBar_subtitle);
            if (!TextUtils.isEmpty(subtitle)) {
                setSubtitle(subtitle);
            }
            Drawable logo = a.getDrawable(C0015R.styleable.ActionBar_logo);
            if (logo != null) {
                setLogo(logo);
            }
            Drawable icon = a.getDrawable(C0015R.styleable.ActionBar_icon);
            if (icon != null) {
                setIcon(icon);
            }
            ...
            setDisplayOptions(a.getInt(C0015R.styleable.ActionBar_displayOptions, 0));
            int customNavId = a.getResourceId(C0015R.styleable.ActionBar_customNavigationLayout, 0);
            if (customNavId != 0) {
            ...
            int height = a.getLayoutDimension(C0015R.styleable.ActionBar_height, 0);
            if (height > 0) {
                LayoutParams lp = r0.mToolbar.getLayoutParams();
                lp.height = height;
                r0.mToolbar.setLayoutParams(lp);
            }
            int contentInsetStart = a.getDimensionPixelOffset(C0015R.styleable.ActionBar_contentInsetStart, -1);
            int contentInsetEnd = a.getDimensionPixelOffset(C0015R.styleable.ActionBar_contentInsetEnd, -1);
            if (contentInsetStart >= 0 || contentInsetEnd >= 0) {
                r0.mToolbar.setContentInsetsRelative(Math.max(contentInsetStart, 0), Math.max(contentInsetEnd, 0));
            }
            int titleTextStyle = a.getResourceId(C0015R.styleable.ActionBar_titleTextStyle, 0);
            if (titleTextStyle != 0) {
                r0.mToolbar.setTitleTextAppearance(r0.mToolbar.getContext(), titleTextStyle);
            }
            int subtitleTextStyle = a.getResourceId(C0015R.styleable.ActionBar_subtitleTextStyle, 0);
            if (subtitleTextStyle != 0) {
                r0.mToolbar.setSubtitleTextAppearance(r0.mToolbar.getContext(), subtitleTextStyle);
            }
            int popupTheme = a.getResourceId(C0015R.styleable.ActionBar_popupTheme, 0);
            if (popupTheme != 0) {
        ...
        r0.mToolbar.setNavigationOnClickListener(new C03401());
    }
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (this.mActionMenuPresenter == null) {
            ...
            this.mActionMenuPresenter.setId(C0015R.id.action_menu_presenter);
        }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new AppCompatSpinner(getContext(), null, C0015R.attr.actionDropDownStyle);
