...
import android.support.v7.recyclerview.C0017R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C03193();
    ...
    static class C03193 implements Interpolator {
        C03193() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C05091();
        ...
        private final Callback mVerticalBoundCheckCallback = new C05102();
        private int mWidth;
        ...
        class C05091 implements Callback {
            C05091() {
            }
        ...
        class C05102 implements Callback {
            C05102() {
            }
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    if (parentMode != Integer.MIN_VALUE) {
                        if (parentMode == 0) {
                            resultSize = 0;
                            resultMode = 0;
                        } else if (parentMode != ErrorDialogData.SUPPRESSED) {
                        }
                    }
                    resultSize = size;
                ...
                resultSize = size;
                if (parentMode != Integer.MIN_VALUE) {
                    if (parentMode != ErrorDialogData.SUPPRESSED) {
                        resultMode = 0;
                    }
                }
                resultMode = Integer.MIN_VALUE;
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0017R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0017R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0017R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0017R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0017R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C05064 implements ProcessCallback {
        C05064() {
        }
    ...
    class C05075 implements Callback {
        C05075() {
        }
    ...
    class C05086 implements Callback {
        C05086() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03201 implements ClassLoaderCreator<SavedState> {
            C03201() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03171();
        ...
        r6.mItemAnimatorRunner = new C03182();
        r6.mViewInfoProcessCallback = new C05064();
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0017R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0017R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0017R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            r6.mEnableFastScroller = a2.getBoolean(C0017R.styleable.RecyclerView_fastScrollEnabled, false);
            if (r6.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0017R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0017R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0017R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0017R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C05075());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C05086());
    }
                        ...
                        case 2:
                            ...
                            if (index >= 0) {
                                ...
                                if (r6.mScrollState != 1) {
                                    boolean startScroll = false;
                                    if (canScrollHorizontally && Math.abs(dx) > r6.mTouchSlop) {
                                        if (dx > 0) {
                                            dx -= r6.mTouchSlop;
                                        } else {
                                            dx += r6.mTouchSlop;
                                    ...
                                    if (canScrollVertically && Math.abs(dy) > r6.mTouchSlop) {
                                        if (dy > 0) {
                                            dy -= r6.mTouchSlop;
                                        } else {
                                            dy += r6.mTouchSlop;
    ...
    private void recoverFocusFromState() {
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus() && getDescendantFocusability() != ImageMetadata.HOT_PIXEL_MODE) {
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0017R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0017R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0017R.dimen.fastscroll_margin));
    }
