...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0015R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0015R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0015R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean lockedExpanded = widthMode == ErrorDialogData.SUPPRESSED;
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0015R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0015R.attr.actionDropDownStyle);
