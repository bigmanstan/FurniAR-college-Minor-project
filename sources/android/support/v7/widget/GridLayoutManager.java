...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        boolean z = false;
        boolean flexibleInOtherDir = otherDirSpecMode != ErrorDialogData.SUPPRESSED;
        ...
        while (pos < count2) {
            ...
            if (r6.mOrientationHelper.getDecoratedMeasurement(view3) != count) {
                ...
                if (r6.mOrientation == 1) {
                    i = remainingSpan2;
                    wSpec = LayoutManager.getChildMeasureSpec(size, ErrorDialogData.SUPPRESSED, horizontalInsets, lp.width, false);
                    otherDirSpecMode = MeasureSpec.makeMeasureSpec(count - maxSizeInOther2, ErrorDialogData.SUPPRESSED);
                    LayoutParams layoutParams = lp;
                } else {
                    i = remainingSpan2;
                    wSpec = MeasureSpec.makeMeasureSpec(count - horizontalInsets, ErrorDialogData.SUPPRESSED);
                    otherDirSpecMode = LayoutManager.getChildMeasureSpec(size, ErrorDialogData.SUPPRESSED, maxSizeInOther2, lp.height, null);
                }
