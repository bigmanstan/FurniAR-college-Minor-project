...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03243 implements OnFocusChangeListener {
        C03243() {
        }
    ...
    class C03254 implements OnLayoutChangeListener {
        C03254() {
        }
    ...
    class C03265 implements OnClickListener {
        C03265() {
        }
    ...
    class C03276 implements OnKeyListener {
        C03276() {
        }
    ...
    class C03287 implements OnEditorActionListener {
        C03287() {
        }
    ...
    class C03298 implements OnItemClickListener {
        C03298() {
        }
    ...
    class C03309 implements OnItemSelectedListener {
        C03309() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C03311 implements ClassLoaderCreator<SavedState> {
            C03311() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0015R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C03321();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0015R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C03221();
        this.mReleaseCursorRunnable = new C03232();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03265();
        this.mTextKeyListener = new C03276();
        this.mOnEditorActionListener = new C03287();
        this.mOnItemClickListener = new C03298();
        this.mOnItemSelectedListener = new C03309();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0015R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0015R.styleable.SearchView_layout, C0015R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0015R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0015R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0015R.id.search_plate);
        this.mSubmitArea = findViewById(C0015R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0015R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0015R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0015R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0015R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0015R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0015R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0015R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0015R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0015R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0015R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0015R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0015R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0015R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0015R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0015R.styleable.SearchView_suggestionRowLayout, C0015R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0015R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03243());
        setIconifiedByDefault(a.getBoolean(C0015R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0015R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0015R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0015R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0015R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0015R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0015R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C03254());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0015R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0015R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0015R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0015R.dimen.abc_dropdownitem_text_padding_left) : 0;
