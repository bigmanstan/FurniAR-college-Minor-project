...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0015R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02911();
        this.mRemoveActionBarHideOffset = new C02922();
        this.mAddActionBarHideOffset = new C02933();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0015R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0015R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0015R.id.action_bar));
        }
    }
