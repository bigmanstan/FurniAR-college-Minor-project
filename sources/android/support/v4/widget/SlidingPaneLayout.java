...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02501 implements ClassLoaderCreator<SavedState> {
            C02501() {
            }
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    ...
                    heightSize2 = MeasureSpec.makeMeasureSpec(widthAvailable - widthMode, ErrorDialogData.SUPPRESSED);
                } else {
                    heightSize2 = MeasureSpec.makeMeasureSpec(lp.width, ErrorDialogData.SUPPRESSED);
                }
                int horizontalMargin = widthMode;
                if (lp.height == -2) {
                    i = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE);
                } else if (lp.height == -1) {
                    i = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, ErrorDialogData.SUPPRESSED);
                } else {
                    i = MeasureSpec.makeMeasureSpec(lp.height, ErrorDialogData.SUPPRESSED);
                }
                widthMode = i;
            ...
            if (child.getVisibility() != i) {
                ...
                if (child.getVisibility() != i) {
                    ...
                    if (!canSlide || child == slidingPaneLayout.mSlideableView) {
                        ...
                        if (lp2.weight > 0) {
                            if (lp2.width != 0) {
                                heightMode = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), ErrorDialogData.SUPPRESSED);
                            } else if (lp2.height == -2) {
                                heightMode = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE);
                            } else if (lp2.height == -1) {
                                heightMode = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, ErrorDialogData.SUPPRESSED);
                            } else {
                                heightMode = MeasureSpec.makeMeasureSpec(lp2.height, ErrorDialogData.SUPPRESSED);
                            }
                            if (canSlide) {
                                childCount2 = widthAvailable - (lp2.leftMargin + lp2.rightMargin);
                                fixedPanelWidthLimit = widthMode;
                                maxLayoutHeight = maxLayoutHeight2;
                                maxLayoutHeight2 = MeasureSpec.makeMeasureSpec(childCount2, ErrorDialogData.SUPPRESSED);
                                if (i != childCount2) {
                                ...
                                fixedPanelWidthLimit = widthMode;
                                maxLayoutHeight = maxLayoutHeight2;
                                child.measure(MeasureSpec.makeMeasureSpec(i + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining2))) / weightSum)), ErrorDialogData.SUPPRESSED), heightMode);
                            }
                        } else {
                            fixedPanelWidthLimit = widthMode;
                            maxLayoutHeight = maxLayoutHeight2;
                        ...
                        if (skippedFirstPass) {
                            ...
                            if (lp2.height == -2) {
                                ...
                                heightMode = ErrorDialogData.SUPPRESSED;
                                childCount2 = MeasureSpec.makeMeasureSpec(maxLayoutHeight2, ErrorDialogData.SUPPRESSED);
                            } else {
                                heightMode = ErrorDialogData.SUPPRESSED;
                                childCount2 = MeasureSpec.makeMeasureSpec(lp2.height, ErrorDialogData.SUPPRESSED);
                            }
                        } else {
                            childCount = childCount2;
                            heightMode = ErrorDialogData.SUPPRESSED;
                            childCount2 = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), ErrorDialogData.SUPPRESSED);
                        }
