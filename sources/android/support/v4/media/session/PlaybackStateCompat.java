...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C02011();
    ...
    static class C02011 implements Creator<PlaybackStateCompat> {
        C02011() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C02021();
        ...
        static class C02021 implements Creator<CustomAction> {
            C02021() {
            }
