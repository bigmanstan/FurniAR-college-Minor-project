...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C01761();
        ...
        static class C01761 implements Creator<MediaItem> {
            C01761() {
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        class C01681 implements Runnable {
            ...
            public void run() {
                if (MediaBrowserImplBase.this.mState != 0) {
                    ...
                    if (MediaBrowserCompat.DEBUG) {
                        if (MediaBrowserImplBase.this.mServiceConnection != null) {
        ...
        public void connect() {
            ...
            this.mState = 2;
            this.mHandler.post(new C01681());
        }

        public void disconnect() {
            this.mState = 0;
            this.mHandler.post(new C01692());
        }
