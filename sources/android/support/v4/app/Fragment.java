...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    class C04562 extends FragmentContainer {
        C04562() {
        }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int requestCode) {
        ...
        while (check != null) {
            if (check != this) {
                ...
                stringBuilder2.append(" as the target of ");
                stringBuilder2.append(this);
                stringBuilder2.append(" would create a target cycle");
    ...
    public void startIntentSenderForResult(IntentSender intent, int requestCode, @Nullable Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws SendIntentException {
        if (this.mHost != null) {
            r9.mHost.onStartIntentSenderFromFragment(this, intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
        ...
        if (this.mFragmentManager != null) {
            if (this.mFragmentManager.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01251());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C04562(), this);
            return;
        }
