...
class FragmentTransition {
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManager, int containerId, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides) {
        ...
        if (sceneRoot2 != null) {
            ...
            if (impl != null) {
                ...
                Object sharedElementTransition = configureSharedElementsReordered(impl, sceneRoot2, nonExistentView, nameOverrides, fragments, sharedElementsOut2, sharedElementsIn2, enterTransition2, exitTransition2);
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManager, int containerId, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides) {
        ...
        if (sceneRoot2 != null) {
            ...
            if (impl != null) {
                ...
                Object sharedElementTransition = configureSharedElementsOrdered(impl, sceneRoot2, nonExistentView, nameOverrides, fragments, sharedElementsOut2, sharedElementsIn2, enterTransition2, exitTransition3);
                ...
                if (sharedElementsOut2 != null) {
                    ...
                    transition = mergeTransitions(impl2, enterTransition3, exitTransition3, sharedElementTransition, inFragment, fragmentContainerTransition.lastInIsPop);
                    if (transition == null) {
                        enteringViews = new ArrayList();
                        impl2.scheduleRemoveTargets(transition, enterTransition3, enteringViews, exitTransition3, sharedElementsOut2, sharedElementTransition, sharedElementsIn2);
                        transition2 = transition;
                        scheduleTargetChange(impl2, sceneRoot2, inFragment, nonExistentView, sharedElementsIn2, enterTransition3, enteringViews, exitTransition3, sharedElementsOut2);
    ...
    private static void scheduleTargetChange(FragmentTransitionImpl impl, ViewGroup sceneRoot, Fragment inFragment, View nonExistentView, ArrayList<View> sharedElementsIn, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews) {
        ...
        OneShotPreDrawListener.add(sceneRoot, c01372);
    }
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Object enterTransition, Object exitTransition) {
        ...
        if (inFragment == null) {
            ...
            OneShotPreDrawListener.add(sceneRoot, c01383);
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Object enterTransition, Object exitTransition) {
        ...
        if (inFragment == null) {
            ...
            if (sharedElementTransition2 != null) {
                ...
                Rect outSharedElements3 = inEpicenter2;
                setOutEpicenter(impl, sharedElementTransition2, exitTransition, outSharedElements, fragmentContainerTransition.firstOutIsPop, fragmentContainerTransition.firstOutTransaction);
                if (obj != null) {
                    fragmentTransitionImpl.setEpicenter(obj, outSharedElements3);
                }
                inEpicenter = outSharedElements3;
            } else {
                outSharedElements2 = outSharedElements;
            }
            ...
            OneShotPreDrawListener.add(sceneRoot, c01394);
            return sharedElementTransition3;
        }
        return null;
    }
            ...
            if (containerId != 0) {
                ...
                if (!isReorderedTransaction && wasAdded2) {
                    ...
                    if (fragment.mState < 1 && manager.mCurState >= 1 && !backStackRecord.mReorderingAllowed) {
                        ...
                        if (!isReorderedTransaction && wasRemoved2 && containerTransition2 != null && containerTransition2.lastIn == fragment) {
                            containerTransition2.lastIn = fragment2;
                        }
                    }
                }
                fragment2 = null;
