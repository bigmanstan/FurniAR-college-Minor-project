...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01502();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01491();
    ...
    class C01502 implements OnItemClickListener {
        C01502() {
        }
