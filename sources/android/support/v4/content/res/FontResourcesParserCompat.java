...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0004R.styleable.FontFamily);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0004R.styleable.FontFamilyFont);
        int weight = array.getInt(array.hasValue(C0004R.styleable.FontFamilyFont_fontWeight) ? C0004R.styleable.FontFamilyFont_fontWeight : C0004R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
        if (1 != array.getInt(array.hasValue(C0004R.styleable.FontFamilyFont_fontStyle) ? C0004R.styleable.FontFamilyFont_fontStyle : C0004R.styleable.FontFamilyFont_android_fontStyle, 0)) {
            z = false;
        }
        boolean isItalic = z;
        int resourceAttr = array.hasValue(C0004R.styleable.FontFamilyFont_font) ? C0004R.styleable.FontFamilyFont_font : C0004R.styleable.FontFamilyFont_android_font;
