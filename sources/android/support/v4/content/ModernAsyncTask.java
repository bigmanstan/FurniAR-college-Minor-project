...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01521();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C04592();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01521 implements ThreadFactory {
    ...
    class C04592 extends WorkerRunnable<Params, Result> {
        C04592() {
        }
