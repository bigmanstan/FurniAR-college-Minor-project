...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0005R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0005R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0005R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0005R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 6) {
                        if (i != 7) {
                            i2 = centerID;
                            connect(i2, 3, firstID, firstSide, firstMargin);
                    ...
                    i2 = centerID;
                    connect(i2, 6, firstID, firstSide, firstMargin);
