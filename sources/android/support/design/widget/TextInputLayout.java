...
public class TextInputLayout extends LinearLayout implements WithHint {
    ...
    class C00831 implements TextWatcher {
        C00831() {
        }
    ...
    class C00842 extends AnimatorListenerAdapter {
        C00842() {
        }
    ...
    class C00864 implements OnClickListener {
        C00864() {
        }
    ...
    class C00875 implements AnimatorUpdateListener {
        C00875() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C00881 implements ClassLoaderCreator<SavedState> {
            C00881() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0008R.styleable.TextInputLayout, defStyleAttr, C0008R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0008R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0008R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0008R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0008R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0008R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0008R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0008R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0008R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0008R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0008R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0008R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0008R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0008R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0008R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0008R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0008R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0008R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0008R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0008R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0008R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        if (this.mEditText == null) {
            ...
            this.mEditText.addTextChangedListener(new C00831());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0008R.id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0015R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0015R.color.error_color_material));
                }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00842()).start();
            } else {
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0008R.id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0015R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0015R.color.error_color_material));
                }
    ...
    void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0008R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0008R.layout.design_text_input_password_icon, this.mInputFrame, false);
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00864());
                }
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C00875());
            }
