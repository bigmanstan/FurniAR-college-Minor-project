...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    class C04481 implements Callback {
        C04481() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C00761 implements ClassLoaderCreator<SavedState> {
            C00761() {
            }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0008R.styleable.NavigationView, defStyleAttr, C0008R.style.Widget_Design_NavigationView);
        ViewCompat.setBackground(this, a.getDrawable(C0008R.styleable.NavigationView_android_background));
        if (a.hasValue(C0008R.styleable.NavigationView_elevation)) {
            ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0008R.styleable.NavigationView_elevation, 0));
        }
        ViewCompat.setFitsSystemWindows(this, a.getBoolean(C0008R.styleable.NavigationView_android_fitsSystemWindows, false));
        this.mMaxWidth = a.getDimensionPixelSize(C0008R.styleable.NavigationView_android_maxWidth, 0);
        if (a.hasValue(C0008R.styleable.NavigationView_itemIconTint)) {
            itemIconTint = a.getColorStateList(C0008R.styleable.NavigationView_itemIconTint);
        } else {
            itemIconTint = createDefaultColorStateList(16842808);
        }
        boolean textAppearanceSet = false;
        int textAppearance = 0;
        if (a.hasValue(C0008R.styleable.NavigationView_itemTextAppearance)) {
            textAppearance = a.getResourceId(C0008R.styleable.NavigationView_itemTextAppearance, 0);
            textAppearanceSet = true;
        }
        ColorStateList itemTextColor = null;
        if (a.hasValue(C0008R.styleable.NavigationView_itemTextColor)) {
            itemTextColor = a.getColorStateList(C0008R.styleable.NavigationView_itemTextColor);
        }
        if (!textAppearanceSet && itemTextColor == null) {
            itemTextColor = createDefaultColorStateList(16842806);
        }
        Drawable itemBackground = a.getDrawable(C0008R.styleable.NavigationView_itemBackground);
        this.mMenu.setCallback(new C04481());
        ...
        if (a.hasValue(C0008R.styleable.NavigationView_menu)) {
            inflateMenu(a.getResourceId(C0008R.styleable.NavigationView_menu, 0));
        }
        if (a.hasValue(C0008R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(a.getResourceId(C0008R.styleable.NavigationView_headerLayout, 0));
        }
        a.recycle();
    }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0015R.attr.colorPrimary, value, true)) {
            return null;
        }
