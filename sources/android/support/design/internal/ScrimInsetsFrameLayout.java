...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C04331 implements OnApplyWindowInsetsListener {
        C04331() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0008R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0008R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0008R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04331());
    }
